        ...
        try:
            ...
            if choice == "0":
                ...
                try:
                    ...
                    print(f"📈 Total Debates: {status['system_stats']['total_debates']}")
                    print(f"✅ Successful Consensus: {status['system_stats']['successful_consensus']}")
                    print(f"⏱️  Average Consensus Time: {status['system_stats']['average_consensus_time']:.1f}s")
                    print()
                ...
                try:
                    import PyQt5
                    print(f"\n🎨 GUI System: ✅ Ready (PyQt5 {PyQt5.QtCore.QT_VERSION_STR})")
                except ImportError:
