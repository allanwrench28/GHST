...
class GHSTAutoHandler:
    ...
    def stop_monitoring(self):
        ...
        print("⏱️ Session time: {session_time:.1f} seconds")
        print("🔄 Continues clicked: {self.stats['continues_clicked']}")
        print("📝 Prompts handled: {self.stats['prompts_handled']}")
    ...
    def _handle_vscode_continue(self):
        ...
        try:
            ...
            vscode_windows = pyautogui.getWindowsWithTitle(
                'Visual Studio Code')
