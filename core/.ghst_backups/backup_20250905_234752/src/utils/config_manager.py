...
class ConfigManager:
    ...
    def __init__(self, config_dir: str = "config"):
        ...
        if PLUGINS_AVAILABLE:
            try:
                ...
                self.logger.info(
                    f"Plugin system enabled with {len(self.plugin_manager.loaded_plugins)} plugins loaded")
    ...
    def load_printer_config(self, config_name: str) -> PrinterConfig:
        ...
        try:
            ...
            self.logger.warning(
                f"Printer config {config_name}.yaml not found, using defaults")
    ...
    def load_material_config(self, config_name: str) -> MaterialConfig:
        ...
        try:
            ...
            self.logger.warning(
                f"Material config {config_name}.yaml not found, using defaults")
    ...
    def load_slicing_config(self, config_name: str) -> SlicingConfig:
        ...
        try:
            ...
            self.logger.warning(
                f"Slicing config {config_name}.yaml not found, using defaults")
    ...
    def enable_experimental_feature(self, feature: str, enabled: bool = True):
        ...
        if enabled:
            self.logger.warning(
                f"⚠️  Experimental feature '{feature}' ENABLED - Use at your own risk!")
        else:
    ...
    def enable_plugin(self, plugin_name: str) -> bool:
        ...
        if result:
            self.logger.warning(
                f"⚠️ Plugin '{plugin_name}' ENABLED - Use at your own risk!")
        return result
    ...
    def validate_config_safety(self) -> List[str]:
        ...
        if self.current_slicing:
            ...
            if enabled_experimental:
                warnings.append(
                    f"⚠️  Experimental features enabled: {
