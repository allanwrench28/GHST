...
class GhostChatInterface:
    ...
    def _handle_visual_query(self, message: str) -> str:
        ...
        themes_list = ', '.join(self.available_themes.values())
        return f"🎨 **Dr. ColorScience**: I can help with visual customization! Available themes: {themes_list}. I also optimize color contrast ratios and ensure accessibility compliance. What specific visual aspect would you like to improve?"

    def _handle_slicing_query(self, message: str) -> str:
        """Handle slicing and AI coding assistance queries."""
        responses = ["⚙️ **Dr. Manufacturing & Dr. Physics**: For optimal slicing, I recommend analyzing your model's geometry first. What's your nozzle diameter and material type?",
    ...
    def _handle_error_query(self, message: str) -> str:
        ...
        return "🚨 **Dr. Error & Dr. FileSystem**: I'm analyzing your issue. Common problems include: file path issues, configuration errors, or dependency conflicts. Can you share the specific error message? I'll cross-reference with our knowledge base."

    def _handle_optimization_query(self, message: str) -> str:
        """Handle optimization and performance queries."""
        return "⚡ **Dr. Efficiency & Dr. Optimization**: I'll analyze performance bottlenecks and suggest improvements. Are you looking to optimize print time, quality, material usage, or software performance?"

    def _handle_materials_query(self, message: str) -> str:
        """Handle material science queries."""
        return "🧪 **Dr. Materials**: I can provide detailed material guidance! Each polymer has unique thermal properties, crystallization behavior, and optimal processing parameters. What material are you working with?"
    ...
    def _handle_general_query(self, message: str) -> str:
        ...
        return (
            "👻 **GHST Agent Collective**: Hello! Our 25 PhD-level specialists "
    ...
    def request_human_approval(self, action_type: str, details: str) -> bool:
        ...
        self.chat_history.append({
            'timestamp': datetime.now().isoformat(),
            'user': 'SYSTEM_REQUEST',
            'response': ("⚖️ **APPROVAL NEEDED**: {action_type}\n{details}\n"
    ...
    def export_chat_log(self, filename: str = None) -> str:
        ...
        if not filename:
            filename = "ghst_chat_log_{int(time.time())}.json"
