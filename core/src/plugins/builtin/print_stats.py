...
class PrintStatsPlugin(BasePlugin):
    ...
    def show_statistics(self):
        ...
        print(
            f"Estimated print time: {self.stats['estimated_time_minutes']:.1f} minutes")
        print(f"Layer count: {self.stats['layer_count']}")
        print(
            f"Estimated filament: {self.stats['estimated_filament_length']:.1f} mm")
        print(
            f"Estimated weight: {self.stats['estimated_filament_weight']:.2f} g")
