...
"""
    ...
    print(f"📁 Executable release package created: {exe_release_dir}")
    print(f"📋 Files created:")
    print(f"   - GHST-Installer-Enhanced.exe")
    print(f"   - Install-GHST-Enhanced.bat")
    print(f"   - README.md")
    ...
    cmd = [
        ...
        "--add-data", f"{script_dir}/releases/v1.0.0-alpha.3/core;core",
        "--add-data", f"{script_dir}/releases/v1.0.0-alpha.3/RELEASE_NOTES.md;.",
...
def main():
    ...
    print(f"🎯 Found GHST: {launcher_path}")
    print("🔄 Starting GHST...")
...
'''
    ...
    try:
        ...
        print(f"❌ Failed to create portable launcher: {e}")
        return False
