    ...
    def validate_installation(self):
        ...
        for test_name, module_path in validation_tests:
            ...
            try:
                ...
                self.log_updated.emit(f"✅ {test_name}: Working")
            except ImportError as e:
                self.log_updated.emit(f"⚠️ {test_name}: {str(e)}")
...
class OptionsPage(QWidget):
    ...
    def init_ui(self):
        ...
        self.developer_install.setToolTip("Include development tools and debug features")
        ...
        self.theme_combo.addItems(["Ghost Dark", "Ghost Light", "Professional"])
...
class CompletionPage(QWidget):
    ...
    def init_ui(self):
        ...
        title.setAlignment(Qt.AlignCenter)
        title.setStyleSheet("font-size: 24px; font-weight: bold; color: #00a86b;")
        layout.addWidget(title)
...
class GHSTInstaller(QMainWindow):
    ...
    def installation_finished(self, success: bool):
        """Handle installation completion."""
        if success:
            QTimer.singleShot(2000, self.go_next)  # Auto-advance after 2 seconds
